...
const municipalLaws = [
    ...
    },
    {
        ...
        description:
            "a. The act of manual evasion shall be when one flees the scene of a crime or evades any law enforcement official by foot, without the use of any motor vehicle or aircraft after failing to comply with any and all visual, verbal, sonic signs or clearly interpretable actions or signals by an Officer.",
        category: "Chapter 2",
    },
    {
        code: "Chapter 2 § 04",
        title: "Motor Evasion",
        description:
            "a. The act of motor evasion shall be when one flees the scene of a crime or evades any law enforcement official with the use of any motor vehicle or aircraft after failing to comply with any and all visual, verbal, sonic signs or clearly interpretable actions or signals by an Officer.",
        category: "Chapter 2",
    },
    {
        code: "Chapter 2 § 05",
    ...
    },
    {
        ...
        description:
            "a. Escape and rescue from correctional facilities shall be the act of leaving a correctional facility, as a subject that is incarcerated, without legal authorization to do so.<br><br>i.  Only officials permitted in law may authorize subjects to be removed or transferred from correctional facilities- and such authorizations may only occur when the subject has a sentence commuted, or such a release is ordered by a judge for other circumstances, as prescribed by law.<br><br>b. Attempting to leave a correctional facility without authorization while incarcerated at that facility shall also be the act of escape and rescue.<br><br>c. Escape and rescue from Prisons shall also be the act when another individual aids the escape of an incarcerated person without sentence commutation or removal by judge; whether by monetary means, vehicular or verbal means.",
        category: "Chapter 2",
    },
    {
        code: "Chapter 2 § 09",
        ...
        description:
            "a. The act of misuse of city services shall be the act of using the services of the city, specifically weapons, cars or aircrafts and providing them as gifts or rewards without authority under law to do so.<br><br>b. The act of misuse of city services shall also be the act of providing city services as defined in subsection (a) which are later commissioned in the act of a violent crime under this Code or Law.",
        category: "Chapter 2",
    },
    {
        code: "Chapter 2 § 10",
    ...
    },
    {
        ...
        description:
            "a. The act of falsification of city records shall be when an individual uses their capacity or power granted to them in a fashion not authorized by law and does so to replace true, correct and approved information into false, incorrect and unaffirmed information and later presents them as true, with intent to deceive.",
        category: "Chapter 2",
    },
    {
        code: "Chapter 2 § 12",
    ...
    },
    {
        ...
        description:
            "a. Second degree murder shall be the act of directly causing a death of another person with malicious intent, lacking premeditation.",
        category: "Chapter 3",
    },
    {
        code: "Chapter 3 § 03",
        title: "Manslaughter",
        description:
            "a. Manslaughter shall be the act of causing a death of another person with no premeditation or malicious intent, however still directly causing a death of another person as a result of criminal negligence.",
        category: "Chapter 3",
    },
    {
        code: "Chapter 3 § 04",
        ...
        description:
            "a. Negligent homicide shall be the act of causing a death of another person with no premeditation or malicious intent, however still directly causing a death of another person as a result of gross negligence.",
        category: "Chapter 3",
    },
    {
        code: "Chapter 3 § 05",
        ...
        description:
            "a. Involuntary manslaughter shall be the act of killing another person as the result of a lawful act done with gross negligence with lack of care and awareness.",
        category: "Chapter 3",
    },
];
