...
const cityCouncilBills = [
  ...
  },
  {
    ...
    description: "Defense of the District and National Sovereignty Act establishing protective measures.",
  ...
  },
  {
    ...
    description: "Establishes an annual remembrance day honoring GeorgeGodsent's contributions to DC.",
