const mockTrialCases = {
  criminal: [
    {
      id: "cr1",
      title: "United States v. Bill (Chair-Charring Case)",
      description: "Defendant charged with attempted arson under 18 U.S.C. \xA7 844(i)",
      ...
      difficulty: "6/10",
      statute: "18 U.S. Code \xA7 844(i) - Attempted arson (unlawful attempt to damage/destroy a building used in interstate commerce)",
      evidence: {
        prosecution: [
...
function getRandomCase(caseType) {
  var _a;
  ...
  return (_a = cases[randomIndex]) != null ? _a : null;
}
function getCaseById(caseType, caseId) {
  if (!["criminal", "civil"].includes(caseType)) {
  ...
  return caseFound != null ? caseFound : null;
}
function getAllCases(caseType) {
  if (!["criminal", "civil"].includes(caseType)) {
...
export { getAllCases as a, getRandomCase as b, getCaseById as g };
